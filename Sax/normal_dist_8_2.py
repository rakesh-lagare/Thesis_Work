# -*- coding: utf-8 -*-
"""
Created on Mon Feb 11 18:36:38 2019
...
def segment_ts(series,windowSize=window_size,skip_offset=skip_offset):
    ...
    #print("dummyuyy",words)
    #print("dummy111111",indices)
...
def complete_word(series=x1,word_len=word_lenth,skip_len=skip_offset):
    ...
    for i in range(0, len(alphabetize)):
        ...
        #complete_indices.append()
    n=0
    for i in complete_word:
        if(len(i) != word_len):
            complete_word.remove(i)
            print("nnnn",n)
            del  complete_indices[n]
        n=n+1
         
         
    print("fdsdfds",complete_word)        
    """
    """  Simillar Words  """
