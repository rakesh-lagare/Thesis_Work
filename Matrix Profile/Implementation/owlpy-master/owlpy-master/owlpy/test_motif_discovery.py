...
import numpy as np
import time
data2 = pd.read_csv('../ECGFiveDays_TRAIN', sep=',', header=None)
label2 = data2.pop(data2.columns[0])
...
Pab, Iab = stamp(ts,ts,130)                       # run the STAMP algorithm to compute the Matrix Profile
plot_motif(ts,ts,Pab,Iab,130)
